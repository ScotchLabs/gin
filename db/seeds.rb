...
In the beginning of the year, you've got tons of options. Meet us at the Activities Fair in September. Come to our Barbecue. Most importantly, come to a general meeting! These are wacky, fun-filled events where the Board fills the rest of the membership in on upcoming auditions, open staff positions, social events, and other juicy tidbits! Later on, watch the website's [[a+http://www.snstheatre.org/|News]] area, [[m+nqr@andrew.cmu.edu|sign up for the S'n'S mailing list]], or watch our bboards for the latest information.")
...
<tr valign=middle>
<td>[[i+online.png]]</td>
<td><b>Online:</b> Go to [[a+http://www.cmu.edu/campaign/ways/online.html]]. Select \"New Gift\", enter the amount you'd like to give, select \"Other\" in the Designation field, and write \"S'n'S 70th Anniversary Initiative\" in the Comments. You will then be asked for information regarding your gift and your payment method.</td>
</tr>
<tr valign=middle>
<td>[[i+phone.png]]</td>
...
<form method='post' action='thankyou.php'><table width=100%><tr><td style=\"width:130px;text-align:right;vertical-align:top\">Name:</td><td><input type='text' name='name' id='name'></td></tr><tr><td style=\"width:130px;text-align:right;vertical-align:top\">Email Address:</td><td><input type='text' name='replyto' id='replyto'></td></tr><tr><td style=\"width:130px;text-align:right;vertical-align:top\">Subject:</td><td><input type='text' name='subject' id='subject'></td></tr><tr><td style=\"width:130px;text-align:right;vertical-align:top\">Message:</td><td><textarea rows='4' cols='50' name='message' id='message'></textarea></td></tr><tr><td></td><td><input type='submit' name='emailBtn' value='Submit' onclick='return validateForm();'></td></tr></table></form>")
